...
const LoginRequest = () => {
  return (
        <motion.div
            ...
            animate='show'
            exit='exit'
            className='login-request-section'
        >
            <div className='login-request-section-container'>
                <h2 className='login-request-section-title'>Welcome to Stonks</h2>
                <p>Stonks is a web-based application that allows a user to sign into their
                    account, log their current stock units and cryptocurrency shares.
                    Stonks is a great choice for new and experienced investors alike.{' '}
                </p>

                <h3 className='login-request-section-subtitle'>
                    Please sign in or sign up to continue
                    <br></br>
                    <Link to='/login'>
                        <Button className='login-request-section-button'>Login</Button>
                    </Link>
                </h3>
            </div>
            <div>
